...
CREATE TABLE T_MASTER_PORTFOLIO (
    ...
    C_PK_ID          UNIQUEIDENTIFIER NOT NULL CONSTRAINT DF_MASTER_PORTFOLIO_PKID DEFAULT NEWID(), -- khóa duy nhất cho API/UI (IDOR-safe); cluster vẫn theo PK natural
...
CREATE TABLE T_MASTER_PORTFOLIO_TICKER (
    ...
    C_PK_ID          UNIQUEIDENTIFIER NOT NULL CONSTRAINT DF_MASTER_PORTFOLIO_TICKER_PKID DEFAULT NEWID(), -- khóa duy nhất cho API/UI
...
CREATE TABLE T_INDEXING_PORTFOLIO (
    ...
    C_PK_ID          UNIQUEIDENTIFIER NOT NULL CONSTRAINT DF_INDEXING_PORTFOLIO_PKID DEFAULT NEWID(), -- khóa duy nhất cho API/UI (IDOR-safe)
...
CREATE TABLE T_REBALANCE_REQUEST (
    ...
    C_PK_ID          UNIQUEIDENTIFIER NOT NULL CONSTRAINT DF_REBREQ_PKID DEFAULT NEWID(), -- khóa duy nhất cho API/UI
