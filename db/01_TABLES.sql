...
CREATE TABLE T_CUSTOMER_NAV_BALANCE (
    ...
    CONSTRAINT UQ_CUSTOMER_NAV_BALANCE_NK UNIQUE (C_BUSINESS_DATE, C_CUST_CODE, C_SI_CODE) -- idempotency
);
...
CREATE TABLE T_SI_HOLDING_BALANCE (
    PK_SI_HOLDING_BALANCE UNIQUEIDENTIFIER NOT NULL CONSTRAINT DF_SI_HOLDING_BALANCE_PKID DEFAULT NEWID(),
    C_BUSINESS_DATE  DATE            NOT NULL,
    C_SI_CODE        VARCHAR(20)     NOT NULL,
    C_TICKER         VARCHAR(20)     NOT NULL,
    C_QUANTITY       DECIMAL(20,0)   NOT NULL,
    ...
    CONSTRAINT PK_SI_HOLDING_BALANCE PRIMARY KEY CLUSTERED (PK_SI_HOLDING_BALANCE),
    CONSTRAINT UQ_SI_HOLDING_BALANCE_NK UNIQUE (C_BUSINESS_DATE, C_SI_CODE, C_TICKER)
);
...
CREATE TABLE T_SI_NAV_BALANCE (
    ...
    C_DAILY_PNL        DECIMAL(20,0)  NOT NULL,
    C_DAILY_RETURN     DECIMAL(10,6) NULL,
    CONSTRAINT PK_SI_NAV_BALANCE PRIMARY KEY CLUSTERED (PK_SI_NAV_BALANCE),
    CONSTRAINT UQ_SI_NAV_BALANCE_NK UNIQUE (C_BUSINESS_DATE, C_SI_CODE)
);

-- NAV/state HIỆN TẠI cấp SI — 1 dòng/SI (~100), overwrite mỗi EOD (J11 MERGE từ T_SI_NAV_BALANCE @d).
