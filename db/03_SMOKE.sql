...
DELETE FROM T_SI_NAV_BALANCE; DELETE FROM T_SI_INDEX_DAILY; DELETE FROM T_SI_HOLDING_BALANCE;
...
VALUES ('KH00001001','SDI01','2026-01-02','ACTIVE',0.01);
INSERT INTO T_MASTER_PORTFOLIO_TICKER (C_SI_CODE,C_EFFECTIVE_DATE,C_TICKER,C_TARGET_WEIGHT) VALUES
...
PRINT '--- T_SI_NAV_BALANCE (SI tổng hợp) ---';
...
FROM T_SI_NAV_BALANCE WHERE C_SI_CODE='SDI01' ORDER BY C_BUSINESS_DATE;
...
FROM T_SI_INDEX_DAILY WHERE C_SI_CODE='SDI01' ORDER BY C_BUSINESS_DATE;
...
INSERT INTO T_INDEXING_PORTFOLIO (C_CUST_CODE,C_SI_CODE,C_JOIN_DATE,C_STATUS) VALUES ('KH00009999','SDI01','2026-01-07','ACTIVE');
BEGIN TRY
