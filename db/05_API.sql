...
BEGIN
    ...
    FROM T_SI_NAV_BALANCE WHERE C_SI_CODE = @C_SI_CODE ORDER BY C_BUSINESS_DATE DESC;
END
GO
...
BEGIN
    ...
    LEFT JOIN   T_SI_NAV_BALANCE       sd ON sd.C_SI_CODE = @C_SI_CODE AND sd.C_BUSINESS_DATE = cd.C_BUSINESS_DATE
...
BEGIN
    ...
    FROM        T_MASTER_PORTFOLIO mp
    LEFT JOIN   T_CUSTOMER_NAV_BALANCE nd ON nd.C_CUST_CODE = @C_CUST_CODE AND nd.C_SI_CODE = @C_SI_CODE
