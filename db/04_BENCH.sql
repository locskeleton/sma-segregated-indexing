...
INSERT INTO T_CUSTOMER_NAV_CURRENT (C_CUST_CODE,C_SI_CODE,C_UNIT,C_CASH,C_PAYABLE_FEE,C_LAST_NAV,C_STATUS,C_LAST_SYNC_DATE)
SELECT C_CUST_CODE, C_SI_CODE, 0, 0, 0, 0, 'ACTIVE', @d FROM T_INDEXING_PORTFOLIO;
