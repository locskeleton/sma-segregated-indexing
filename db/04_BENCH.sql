...
INSERT INTO T_CUSTOMER_NAV_CURRENT (C_SI_ACCOUNT,C_CUST_CODE,C_MASTER_CODE,C_UNIT,C_CASH,C_PAYABLE_FEE,C_LAST_NAV,C_STATUS,C_LAST_SYNC_DATE)
SELECT C_SI_ACCOUNT, C_CUST_CODE, C_MASTER_CODE, 0, 0, 0, 0, 'ACTIVE', @d FROM T_INDEXING_PORTFOLIO;

INSERT INTO T_CASHFLOW_EVENT (C_SI_ACCOUNT,C_CUST_CODE,C_MASTER_CODE,C_BUSINESS_DATE,C_EVENT_TYPE,C_AMOUNT)
SELECT C_SI_ACCOUNT, C_CUST_CODE, C_MASTER_CODE, @d, 'INITIAL', @nTick*@qty*@price FROM T_INDEXING_PORTFOLIO;
