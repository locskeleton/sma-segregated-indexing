...
INSERT INTO T_SI_ASSET_DAILY (C_BUSINESS_DATE,C_SI_ACCOUNT,C_CUST_CODE,C_MASTER_CODE,C_STOCK_VALUE,C_CASH,C_PENDING_CASH,C_DIV_CASH,C_FEE_ACCUM,C_CASH_IN,C_CASH_OUT)
SELECT @d, C_SI_ACCOUNT, C_CUST_CODE, C_MASTER_CODE, @nTick*@qty*@price, 0,0,0,0, @nTick*@qty*@price, 0 FROM T_SI_PORTFOLIO;
