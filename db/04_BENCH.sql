...
TRUNCATE TABLE T_SI_INCOME_FEE;  TRUNCATE TABLE T_MASTER_INDEX_DAILY;
...
-- phí QL accrue 1%/năm cho mọi master (config-driven)
INSERT INTO T_FEE_CONFIG (C_MASTER_CODE, C_FEE_TYPE, C_FEE_GROUP, C_RATE)
SELECT C_MASTER_CODE, 'MGMT_FEE', 'PAYABLE', 0.01 FROM T_MASTER_PORTFOLIO;
